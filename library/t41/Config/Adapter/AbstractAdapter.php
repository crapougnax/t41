...
abstract class AbstractAdapter implements AdapterInterface {
	 ...
	 * Constructor
	 * 
	 * @param array $file Configuration file paths
	 * @param array $params
	 */
	public function __construct(array $file = array(), array $params = null)
	{   
		$this->_filePath = $file;
	}
	...
	/**
	 * Define path or array of paths to search into
	 * @param mixed $path
	 */
	public function setPath($path)
	{
		$this->_filePath = (array) $path;
		return $this;
	}
