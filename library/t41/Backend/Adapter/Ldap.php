 ...
 * @license    http://www.t41.org/license/new-bsd     New BSD License
 */
class t41_Backend_Adapter_Ldap extends t41_Backend_Adapter_Abstract {
	 ...
	 * @var array
	 */
	protected $_operators = array(t41_Condition::OPERATOR_GTHAN => '>'
								, t41_Condition::OPERATOR_LTHAN => '<'
								, t41_Condition::OPERATOR_EQUAL => '='
								, t41_Condition::OPERATOR_DIFF  => '=' // needs specific syntax (!(field=val))
								 );
	/**
	 * Base DN
	 * @var string
	...
	public function __construct(t41_Backend_Uri $uri, $alias = null)
	{
		if (! extension_loaded('ldap')) {
			...
			throw new t41_Backend_Exception(array("BACKEND_REQUIRED_EXT", 'ldap'));
		}
	...
	public function create(t41_Data_Object $do)
	{
		...
		foreach ($do->getProperties() as $property) {
			...
			if (! $property instanceof t41_Property_Collection) {
...
*/			
			...
			throw new t41_Backend_Exception("LDAP Query error: " . $e->getMessage());
		}
	...
	protected function _buildConditionStatement($field, array $clauses, $mode = 'AND')
	{
		...
		foreach ($clauses as $key => $clause) {
			...
			if (in_array(t41_Condition::OPERATOR_DIFF, $ops)) {
			...
			if ($value instanceof t41_Object_Model) {
					...
					throw new t41_Backend_Exception("LDAP Adapter doesn't support conditions which value is an object: " . $field);
			}
	...
	protected function _connect($string = null)
	{
		...
		*/
			...
			if ($this->_ressource === false) {
				...
				throw new t41_Backend_Exception("echec connexion LDAP");
			}
